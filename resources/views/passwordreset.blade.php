          ...
          <div class="col-md-8">
            <div class="card">
              <div class="card-header">
                <div class="row">
                  <div class="col-md-9">
                <h5 class="title">Update User Password</h5>
                  </div>
              ...
              <div class="card-body">
                <form id="userpassword" action="updatepassword" method="post" enctype="multipart/form-data">
                  {{ csrf_field() }}
                  <div class="row">
                    <div class="col-md-12">
                    ...
                    <div class="col-md-4 pl-1">
                      <div class="form-group">
                        <label>New Password Again</label>
                          <input type="password" name="newpasswordagain" id="newpasswordagain" class="form-control" placeholder="Re-enter New Password">
                      </div>
                    </div>
