<script>
	...
	//process this when user click on pay
	  $(document).ready(function(){
	    $("#createaction").on('submit', function(event){
	      ...
	      $.ajax({
	        ...
	        success: function(data){
	          ...
	          Swal.fire({
		        title: "Success!",
		        text: "Action have been updated successfully!",
	    ...
	    $.ajax({
	    	...
	    	success:function(data){
	    		...
	    		if(data.status == 'success'){
	    			...
	    			Swal.fire({
				        title: "Success!",
				        text: "Action have been deleted successfully!",
				        buttonsStyling: false,
				        confirmButtonClass: "btn btn-success",
				        type: "success"
				      });
