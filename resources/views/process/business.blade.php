<script>
    ...
    $("#adminpercent").change(function(){
        var adminpercent = $("#adminpercent").val();
        var amount = $("#amount").val();
        
        var percent = adminpercent/100;
        
        var adminfeeamount = percent * amount;
        
        $("#adminfeeamount").val(adminfeeamount);
    ...
    @php $x=1 @endphp
    var monthamount = parseFloat($("#amount").val()) / parseInt($("#duration").val());
    $("#monthamount").val(monthamount.toFixed(2));
  ...
  @endisset
	  ...
	  $("#businessapplication").on('submit', function(event){
	      event.preventDefault();
	      
	      $.ajax({
	        type: 'POST',
	        url: 'submitbusinessrequest',
	        data: new FormData(this),
	        contentType: false,
	        cache: false,
	        processData: false,
	  ...
	  $("#businessapplicationupdate").on('submit', function(event){
	      event.preventDefault();
	      
	      $.ajax({
	        type: 'POST',
	        url: 'updatebusinessrequest',
	        data: new FormData(this),
	        contentType: false,
	        cache: false,
	        processData: false,
