                ...
                <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{ $test->user_score }}</td>
                      <td>{{ $test->user_percentage }}</td>
                      <td>{{ $test->created_at }}</td>
                      <td class="">
                        <a href="resultdetails?test_id={{ $test->test_id }}" class="btn btn-round btn-info btn-icon btn-sm like"><i class="fas fa-edit"></i></a>
                      </td>
                    </tr>
                    @endforeach
                    @endisset
